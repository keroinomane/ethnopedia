	...
	<body>
		...
		<div class="container">
			...
			<c:if test="${nick != null}">
			    ...
			    <br><br>
				<img src="${contextPath}/resources/img/graficiMtdna/nord.png" width="80%"/>
				<img src="${contextPath}/resources/img/graficiMtdna/centro.png" width="80%"/>
				<img src="${contextPath}/resources/img/graficiMtdna/sud.png" width="80%"/>
				<img src="${contextPath}/resources/img/graficiMtdna/sicilia.png" width="80%"/>
				<img src="${contextPath}/resources/img/graficiMtdna/sardegna.png" width="80%"/>
		    </c:if>  	
		</div>
