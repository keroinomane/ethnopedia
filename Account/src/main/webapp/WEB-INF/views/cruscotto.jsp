...
<html lang="en">
	<head>
		...
		<script>
			...
			function control() {
				if ($('#downstream').val() == '' || $('#clade').val() == '' || $('#subclade').val() == '')
				...
				<div align=center width=100%>
					...
					<c:if test="${ydna != null}">
				       	<form:form action="${contextPath}/saveYdna" method="post" modelAttribute="ydna">
							<table>
								<tr>
									<td align="right">Cognome: </td><td align=center><form:input path="ydnaId.cognome" value="${ydna.ydnaId.cognome}" /></td>
									<td align="center"><br><i>Clicca sull'immagine per ingrandirla.</i></td>
								</tr>
								<tr><td align="right">Nome: </td><td align=center><form:input path="nome" value="${ydna.nome}" /></td>
								...
								<tr><td align="right">Provincia: </td><td align=center><form:input path="ydnaId.provincia" value="${ydna.ydnaId.provincia}" /></td></tr>
							</table>
		
							<table style="width:40%;">
								<tr>
									<td align="center"><a href="${contextPath}/admin" class="btn btn-default">Indietro</a></td>
									<td align="center"><input id="bottone" class="btn btn-primary" type="submit" value="Inserisci" disabled /></td>
								</tr>
							</table>
							<div style="display:none;">
							<input type="text" name="idBozza" value="${idOld}" />
							</div>
						</form:form>
					</c:if>
					...
					<c:if test="${mtdna != null}">
						<form:form action="${contextPath}/saveMtdna" method="post" modelAttribute="mtdna">
							<table style="width:50%;">
								<tr>
									<td align="right">Cognome: </td><td align=center><form:input path="mtdnaId.cognome" value="${mtdna.mtdnaId.cognome}" /></td>
								</tr>
								<tr><td align="right">Nome: </td><td align=center><form:input path="mtdnaId.nome" value="${mtdna.mtdnaId.nome}" /></td>
								</tr>
								...
								<tr><td align="right">Aplogruppo completo: </td><td>
									<form:input path="clade" id="cladem" value="${mtdna.clade}" style="width:25%;" />
								...
								<tr><td align="right">Regione: </td><td>
									<form:select path="regione" value="${mtdna.regione}" id="regione">
									   <form:option value="Abruzzo" class="centro">Abruzzo</form:option>
									   <form:option value="Basilicata" class="sud">Basilicata</form:option>
									   <form:option value="Calabria" class="sud">Calabria</form:option>
									   <form:option value="Campania" class="sud">Campania</form:option>
								...
								<tr><td align="right">Provincia: </td><td align=center><form:input path="mtdnaId.provincia" value="${mtdna.mtdnaId.provincia}" /></td></tr>
							</table>
		
							<table style="width:40%;">
								<tr>
									<td align="center"><a href="${contextPath}/admin" class="btn btn-default">Indietro</a></td>
									<td align="center"><input class="btn btn-primary" type="submit" value="Inserisci"/></td>
								</tr>
							</table>
							<div style="display:none;">
							<input type="text" name="idBozza" value="${idOld}" />
